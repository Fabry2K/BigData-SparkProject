...
def analyze_with_hadoop(inputs, mapper_key, reducer_key):
    results = {}
...
def analyze():
    ...
    # caricamento file su hdfs aws
    mapper_key, reducer_key, inputs = upload_project()

    # analisi su cluster aws con hadoop
    analyze_with_hadoop(inputs, mapper_key, reducer_key)
