...
analysis_3_1.initialize_files(original_file)      # inizializza i file per le analisi, sia per locale che per cluster
...
# analysis_3_3.initialize_files(original_file)      # inizializza i file per le analisi, sia per locale che per cluster

# analysis_3_3.analize_local(spark_local)  # analisi 3.3 locale
