...
def analyze_with_spark_core(spark):
    ...
    plot.plot_analisi(timer_spark_3_1_quarter, timer_spark_3_1_half, timer_spark_3_1_normal, timer_spark_3_1_double, timer_spark_3_1_quadruple, "Analisi 3.1 Spark Core Locale", "output/local/spark/spark_core_local_analysis_3_1.png")
...
def analyze_with_spark_sql(spark):
    ...
    plot.plot_analisi(timer_spark_sql_3_1_quarter, timer_spark_sql_3_1_half, timer_spark_sql_3_1_normal, timer_spark_sql_3_1_double, timer_spark_sql_3_1_quadruple, "Analisi 3.1 Spark SQL Locale", "output/local/spark/spark_sql_local_analysis_3_1.png")
