...
#   # file 1/4x
    timer_hadoop_3_1_quarter = hadoop_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1_quarter", None, "analisi_3_1.csv", "cluster/quarter/hadoop_3_1_output", log_path)
    
#   # file 1/2x
    timer_hadoop_3_1_half = hadoop_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1_half", None, "analisi_3_1.csv", "cluster/half/hadoop_3_1_output", log_path)

#   # file 1x
    timer_hadoop_3_1 = hadoop_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1", "output/hadoop_3_1_output", "analisi_3_1.csv", "cluster/hadoop_3_1_output", log_path)

#   # file 2x
    timer_hadoop_3_1_double = hadoop_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1_double", None, "analisi_3_1.csv", "cluster/double/hadoop_3_1_output", log_path)

#   # file 4x
    timer_hadoop_3_1_quadruple = hadoop_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1_quadruple", None, "analisi_3_1.csv", "cluster/quadruple/hadoop_3_1_output", log_path)
