...
#   # file 1/4x
    timer_hadoop_3_1_quarter = cluster_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1_quarter.csv", None, log_path)
    
#   # file 1/2x
    timer_hadoop_3_1_half = cluster_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1_half.csv", None, log_path)

#   # file 1x
    timer_hadoop_3_1 = cluster_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1.csv", "output/cluster/hadoop_3_1_output", log_path)

#   # file 2x
    timer_hadoop_3_1_double = cluster_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1_double.csv", None, log_path)

#   # file 4x
    timer_hadoop_3_1_quadruple = cluster_executor("hadoop_3_1/mapper.py", "hadoop_3_1/reducer.py", "files/analisi_3_1_quadruple.csv", None, log_path)
