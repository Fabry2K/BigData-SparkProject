...
# HADOOP output log
log_path = "output/cluster/hadoop_3_3/hadoop_logs.txt"
...
def upload_project():
    ...
    mapper_key, reducer_key = upload_mapper_reducer(
        "hadoop_3_3/mapper.py",
        "hadoop_3_3/reducer.py"
    )
...
def analyze():
    ...
    results, execution_time = analyze_with_hadoop(
        ...
        mapper_key,
        reducer_key,
        "output/cluster/hadoop_3_3/hadoop_logs.txt"
    )
    ...
    plot.plot_analisi(
        ...
        "Analisi 3.3 Hadoop Map Reduce",
        "output/cluster/hadoop_3_3/hadoop_analysis.png"
    )
